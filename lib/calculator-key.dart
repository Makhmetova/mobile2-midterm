...
import 'package:kuralay_mobile2_midterm/key-symbol.dart';
  ...
  Color get color {
    switch (symbol.type) {
      case KeyType.FUNCTION:
        return Color.fromARGB(255, 86, 88, 89);

      case KeyType.OPERATOR:
        return Color.fromARGB(255, 243, 162, 59);

      case KeyType.INTEGER:
      default:
        return Color.fromARGB(255, 113, 115, 117);
    }
  }

  static dynamic press(CalculatorKey key) => KeyController.fire(KeyEvent(key));
